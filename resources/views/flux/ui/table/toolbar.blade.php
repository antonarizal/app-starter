...
<div class="flex justify-between items-center mb-4 gap-3">
    ...
    <div class="w-full lg:w-1/2">
        ...
        <div class="flex flex-row gap-4">
            ...
            @endif
            <div class="flex-2">
                <flux:input size="sm"  icon="magnifying-glass" placeholder="{{ $placeholder }}"
    ...
    @endif
    @if ($showImportButton)
        <flux:button size="sm" icon="arrow-up-circle" variant="primary" color="gray" wire:click="import">Import</flux:button>
    @endif
    </flux:button.group>
