...
class GenerateInput extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'generate:input {name : The name of the input file} {--layout= : The layout to use for the view} {--force : Overwrite the view file if it exists} {--table= : Create an inline view} {--model= : Create Model an inline view}';
   ...
   <div class="mb-3">
    ...
    <div class="w-full max-w-lg gap-2 bg-gray-50 dark:bg-gray-700 p-6 border border-default rounded-lg shadow-xs">
        <form wire:submit.prevent="save">
            <div class="space-y-6">
                <h5 class="text-xl font-semibold text-heading mb-6">{{ $modalName }}</h5>
                $inputModals
            </div>
        </form>
    </div>
